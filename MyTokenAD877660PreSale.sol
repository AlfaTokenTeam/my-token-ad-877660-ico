...
import "./MyTokenAD877660.sol";

contract MyTokenAD877660PreSale {
    MyTokenAD877660 public token;
    ...
    function MyTokenAD877660PreSale(
        MyTokenAD877660 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenAD877660(_token);
